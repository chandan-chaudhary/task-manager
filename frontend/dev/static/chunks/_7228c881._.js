...
const authService = {
   ...
   */ async login (credentials) {
        await delay(800);
        const user = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.email === credentials.email);
   ...
   */ async register (data) {
        await delay(1000);
        if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].some((u)=>u.email === data.email)) {
            return {
   ...
   */ async getCurrentUser () {
        await delay(300);
        return {
            data: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockCurrentUser"]
        };
    },
    /**
   * Logout current user.
   ...
   */ async updateProfile (data) {
        ...
        return {
            data: {
                ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockCurrentUser"],
                ...data,
                updatedAt: new Date().toISOString()
            }
        };
...
const taskService = {
   ...
   */ async getTasks (filters, sort) {
        await delay(600);
        let tasks = [
            ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockTasks"]
        ];
        // Apply filters
        if (filters) {
            ...
            if (filters.assignedToMe) {
                tasks = tasks.filter((t)=>t.assignedToId === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockCurrentUser"].id);
            }
            if (filters.createdByMe) {
                tasks = tasks.filter((t)=>t.creatorId === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockCurrentUser"].id);
            }
            if (filters.overdue) {
   ...
   */ async getTask (id) {
        await delay(400);
        const task = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockTasks"].find((t)=>t.id === id);
        if (!task) {
            return {
   ...
   */ async createTask (data) {
        await delay(500);
        const newTask = {
            id: String(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockTasks"].length + 1),
            ...data,
            assignedToId: data.assignedToId || null,
            creatorId: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockCurrentUser"].id,
            creator: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockCurrentUser"],
            assignedTo: data.assignedToId ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.id === data.assignedToId) || null : null,
            createdAt: new Date().toISOString(),
            updatedAt: new Date().toISOString()
        };
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockTasks"].unshift(newTask);
        return {
            data: newTask
        };
    },
   ...
   */ async updateTask (id, data) {
        await delay(400);
        const taskIndex = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockTasks"].findIndex((t)=>t.id === id);
        if (taskIndex === -1) {
            return {
                error: "Task not found"
            };
        ...
        const updatedTask = {
            ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockTasks"][taskIndex],
            ...data,
            assignedTo: data.assignedToId !== undefined ? data.assignedToId ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.id === data.assignedToId) || null : null : __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockTasks"][taskIndex].assignedTo,
            updatedAt: new Date().toISOString()
        };
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockTasks"][taskIndex] = updatedTask;
        return {
            data: updatedTask
        };
    },
   ...
   */ async deleteTask (id) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockTasks"].splice(taskIndex, 1);
        return {
...
const userService = {
   ...
   */ async getUsers () {
        await delay(400);
        return {
            data: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"]
        };
    },
    /**
   * Get user by ID.
   ...
   */ async getUser (id) {
        await delay(300);
        const user = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.id === id);
        if (!user) {
            return {
...
const notificationService = {
   ...
   */ async getNotifications () {
        await delay(300);
        return {
            data: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockNotifications"]
        };
    },
    /**
   ...
   */ async markAsRead (id) {
        await delay(200);
        const notification = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockNotifications"].find((n)=>n.id === id);
        if (!notification) {
            return {
   ...
   */ async markAllAsRead () {
        await delay(300);
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockNotifications"].forEach((n)=>{
            n.read = true;
        });
        return {
...
const dashboardService = {
   ...
   */ async getStats () {
        await delay(500);
        return {
            data: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDashboardStats"]
        };
    }
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
function AuthProvider({ children }) {
    ...
    const updateProfile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[updateProfile]": async (data)=>{
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].updateProfile(data);
            if (response.error) {
                toast({
                    title: "Update failed",
                    description: response.error,
...
_s(AuthProvider, "EsMTAiL0G/v6DuiIjsoVpMdZh8Q=", false, function() {
    return [
...
//# sourceMappingURL=_7228c881._.js.map